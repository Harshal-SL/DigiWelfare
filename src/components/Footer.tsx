...
export const Footer = () => {
  return (
    <footer className="bg-welfare-800 text-white py-12 px-4 mt-auto">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="bg-white text-welfare-500 p-2 rounded-md">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link to="/schemes" className="hover:text-white transition">Schemes</Link></li>
